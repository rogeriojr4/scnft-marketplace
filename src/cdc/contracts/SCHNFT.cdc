...
pub contract SCHNFT: NonFungibleToken {
  ...
  pub resource NFT: NonFungibleToken.INFT {
    ...
    init(_ipfsHash: String, _metadata: {String: String}) {
      self.id = SCHNFT.totalSupply
      SCHNFT.totalSupply = SCHNFT.totalSupply + 1
  ...
  pub resource interface CollectionPublic {
    pub fun borrowEntireNFT(id: UInt64): &SCHNFT.NFT
  }
  ...
  pub resource Collection: NonFungibleToken.Receiver, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, CollectionPublic {
    ...
    pub fun deposit(token: @NonFungibleToken.NFT) {
      let myToken <- token as! @SCHNFT.NFT
    ...
    pub fun borrowEntireNFT(id: UInt64): &SCHNFT.NFT {
      ...
      return reference as! &SCHNFT.NFT
    }
  ...
  pub fun createToken(ipfsHash: String, metadata: {String: String}): @SCHNFT.NFT {
