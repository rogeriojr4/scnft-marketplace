...
pub contract MetaFoodToken {
    ...
    pub resource VaultMinter {
        ...
        pub fun mintTokens(amount: UFix64, recipient: Capability<&AnyResource{Receiver}>) {
            ...
            MetaFoodToken.totalSupply = MetaFoodToken.totalSupply + UFix64(amount)
    ...
    init() {
        ...
        self.account.save(<-vault, to: /storage/MFReceiver)
        ...
        self.account.link<&VaultMinter>(/private/Minter, target: /storage/MFMinter)
    }
}
